...
> Inspired by [perryvegehan/UPI_Without_Internet](https://github.com/perryvegehan/UPI_Without_Internet).
> This version adds authentication, real-database support, and several
> production-readiness fixes on top of that original demo — see the
